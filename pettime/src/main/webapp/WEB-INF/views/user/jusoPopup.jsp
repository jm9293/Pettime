...
<script type="text/javascript" src="${pageContext.request.contextPath}/userJS/addrlink.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js" integrity="sha384-UO2eT0CpHqdSJQ6hJty5KVphtPhzWj9WO1clHTMGa3JDZwrnQq4sF86dIHNDz0W1" crossorigin="anonymous"></script>
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/userCSS/addrlink.css"></link>
...
<script language="javascript">
	...
	function setParent(){
		...
		opener.app.$route.matched[0].instances.default.jusoCallBack(rtRoadFullAddr, rtSiNm, rtSggNm);
	...
	<form name="AKCFrm" id="AKCFrm" method="post">
		...
		<div class="pop-address-search" style="width: 100%;" >
			...
			<div style="height: 365px;" id="searchContentBox">
				...
				<!-- //상세주소 입력 -->
			<div class="logo" style="display: block;" >Pettime</div>
			</div>
		</div>
		</form>
</body>
